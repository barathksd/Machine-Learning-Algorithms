# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 15:16:34 2020
...
algorithms['dbscan'] = cluster.DBSCAN(eps=0.3) # Doesn't need pre-defined cluster size
...
print('kmeans       ','gmm       ','ward_linkage         ','average_linkage         ','single_linkage        ','spectral       ','dbscan')
plt.show()
